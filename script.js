...
function writeValues() {
  document.getElementById("txt1").value = origArray[0];
  document.getElementById("txt2").value = origArray[1];
  document.getElementById("txt3").value = origArray[2];
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn2.addEventListener("click", function () {
    ...
    document.getElementById("txt1").value = newArray[0];
    document.getElementById("txt2").value = newArray[1];
    document.getElementById("txt3").value = newArray[2];
  });
